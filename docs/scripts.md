...
| `fm-teardown.sh`         | Fail-closed task and secondmate retirement; [configuration](configuration.md#runtime-backend-configbackend--fm_backend) owns recovery exceptions |
