...
| `/quiet`           | Batch routine supervision while you stay and chat until an explicit `/quiet off`; unavailable on Pi and pi-signed ([entry and exit](.agents/skills/quiet/SKILL.md)). |
