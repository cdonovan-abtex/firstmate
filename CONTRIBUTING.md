...
- For harness-adapter changes, load [harness-adapters](.agents/skills/harness-adapters/SKILL.md) for integration surfaces and operating facts, and [firstmate-coding-guidelines](.agents/skills/firstmate-coding-guidelines/SKILL.md) for harness-dependent verification policy.
