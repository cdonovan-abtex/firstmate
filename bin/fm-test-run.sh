...
family_for_basename() {
  case "$1" in
    ...
    fm-documentation-audiences.test.sh|fm-agent-context.test.sh|fm-ensure-agents-md.test.sh|fm-grok-harness.test.sh|\
    ...
    fm-pi-branch-responsiveness-live-e2e.test.sh|fm-pi-result-continuation-herdr-live-e2e.test.sh|\
...
tests/fm-pi-result-continuation-herdr-live-e2e.test.sh 23
...
families_for_changed_path() {
  ...
  case "$path" in
    ...
    bin/fm-brief.sh|bin/fm-agent-context.py|bin/fm-ensure-agents-md.sh|bin/fm-crew-state.sh|\
